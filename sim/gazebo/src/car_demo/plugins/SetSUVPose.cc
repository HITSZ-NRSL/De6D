...
#include "SetSUVPose.hh"

using namespace gazebo;

// Register this plugin with the simulator
GZ_REGISTER_MODEL_PLUGIN(SetSUVPose)

/////////////////////////////////////////////////
void SetSUVPose::Load(physics::ModelPtr _model, sdf::ElementPtr /*_sdf*/)
{
  this->model = _model;

  this->connections.push_back(event::Events::ConnectWorldUpdateEnd(
      std::bind(&SetSUVPose::OnUpdate, this)));
}

/////////////////////////////////////////////
void SetSUVPose::OnUpdate()
{
  ...
  pose += ignition::math::Pose3d(-0.006,
                                 0,
                                 0,
                                 0,
                                 0,
