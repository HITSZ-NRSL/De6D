...
dt_result_path = "../output/slopekitti_models/pv_rcnn/default/eval/epoch_8369/val/slope_kitti/result.pkl"
...
result, _ = kitti_eval.get_official_eval_result(gt_annos, dt_annos, current_classes=['Car'])
print(result)
