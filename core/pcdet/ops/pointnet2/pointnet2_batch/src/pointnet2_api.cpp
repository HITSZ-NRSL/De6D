...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    ...
    m.def("ball_query_cnt_wrapper", &ball_query_cnt_wrapper_fast, "ball_query_cnt_wrapper_fast");
    m.def("ball_query_dilated_wrapper", &ball_query_dilated_wrapper_fast, "ball_query_dilated_wrapper_fast");
    m.def("grid_query_wrapper", &grid_query_wrapper_fast,"grid_query_wrapper_fast");
